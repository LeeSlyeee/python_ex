...
# 필요한 함수 목록 
#  - 성적입력 함수 func_input_score() // 완성
#  - 학생에 따른 점수 평균을 구하는 함수
#  - 전체학생의 평균을 구하는 함수
#  - 과목별 최대 점수를 구하는 함수 
#  - 과목별 최소 점수를 구하는 함수
...
def find_max_scores(subject_list, student_dict):
    max_scores = {}
    ...
    print(max_scores) 
# find_max_scores(subject_list, tmp_data)




def find_min_scores(subject_list, student_dict):
    min_scores = {}
    all_scores = student_dict.values()

    # subject_list의 길이를 사용하여 0부터 시작하는 인덱스 생성.
    ...
    print(min_scores)
# find_min_scores(subject_list, tmp_data)
...
def score_manager_program():
    ...
    ---------------------------------------------------
        ...
        - 학생 별 평균값을 구하려는 경우 "학생평균"
        - 전체 학생의 평균값을 구하려는 경우 "전체평균"
        - 각 과목별 최고 점수를 구하려는 경우 "과목최고"
        - 각 과목별 최소 점수를 구하려는 경우 "과목최소"
    ---------------------------------------------------
